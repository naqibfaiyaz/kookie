...
const routes: Routes = [
  { path: '', redirectTo: 'home/my_card', pathMatch: 'full' },
  ...
  { path: 'points-history', loadChildren: './pages/points-history/points-history.module#PointsHistoryPageModule', canActivate: [AuthGuard] },
